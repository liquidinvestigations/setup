...
node('cloud') {
    ...
    def liquid_prerequisites_cloud_image = 'https://jenkins.liquiddemo.org/job/setup-prerequisites/job/prerequisites/lastSuccessfulBuild/artifact/liquid-cloud-x86_64-prerequisites.img.xz'
